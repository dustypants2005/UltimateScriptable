...
public class MouseLook {
  ...
  public void LookRotation(Transform character, Transform camera, Vector2 rs) {
    var x = rs.x;
    var y = rs.y;
    ...
    float yRot = Mathf.Pow(x, RotPower) * XSensitivity;
    float xRot = Mathf.Pow(y, RotPower) * YSensitivity;
